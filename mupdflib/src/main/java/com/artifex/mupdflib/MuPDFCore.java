...
public class MuPDFCore {
    ...
    private native String metaTrapped();

    private native String metaModDate();

    private native String metaProducer();

    private native String metaCreator();

    private native String metaKeywords();

    private native String metaSubject();

    private native String metaAuthor();

    private native String metaPublishDate();

    private native String metaTitle();

    public String getMetaTrapped() {
        return metaTrapped();
    }

    public String getMetaModDate() {
        return metaModDate();
    }
    ...
    public String getMetaPublishDate() {
        return metaPublishDate();
    }
